...
void run_rosenbrock() {
    ...
    for(int i =0; i < n_of_experimetns; i++) {
        ...
        std::cout << "eksperyment nr: "<< i << " Liczba rekordów : " << rosenbrock_eval_5_dim.size() << "Best fitness: "
                  << rosenbrock_eval_5_dim.back() << std::endl;
        std::cout << "Liczba wywołań funkcji: " << function_call_count << std::endl;
        rosenbrock_eval_5_dim_all.push_back(rosenbrock_eval_5_dim);
        function_call_count = 0;

        // std::vector<double> rosenbrock_eval_10_dim = evolutionary_algorithm(0.5, 1, -30, 30, 10, n_of_dim_1, 3);
        ...
        // function_call_count = 0;
        //
        // std::vector<double> rosenbrock_eval_15_dim = evolutionary_algorithm(0.5, 1, -30, 30, 10, n_of_dim_1, 3);
...
void run_salomon() {
    ...
    for(int i =0; i < n_of_experimetns; i++) {
        ...
        std::vector<double> salomon_eval_10_dim = evolutionary_algorithm(0.5, 2, -100, 100, 10, n_of_dim_1,3);
        ...
        std::vector<double> salomon_eval_15_dim = evolutionary_algorithm(0.5, 2, -100, 100, 10, n_of_dim_1 ,3);
