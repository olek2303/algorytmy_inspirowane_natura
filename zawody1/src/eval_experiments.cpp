...
void run_rosenbrock() {
    ...
    for(int i =0; i < n_of_experimetns; i++) {
        std::vector<double> rosenbrock_eval_5_dim = evolutionary_algorithm(0.5, 1, -30, 30, 45, n_of_dim_1, 5);
        ...
        std::vector<double> rosenbrock_eval_15_dim = evolutionary_algorithm(0.5, 1, -30, 30, 100, n_of_dim_2, 18);
        ...
        std::vector<double> rosenbrock_eval_30_dim = evolutionary_algorithm(0.5, 1, -30, 30, 200, n_of_dim_3, 35);
...
void run_salomon() {
    ...
    for(int i =0; i < n_of_experimetns; i++) {
        std::vector<double> salomon_eval_5_dim = evolutionary_algorithm(0.5, 2, -100, 100, 45, n_of_dim_1, 5);
        ...
        std::vector<double> salomon_eval_15_dim = evolutionary_algorithm(0.5, 2, -100, 100, 100, n_of_dim_2, 18);
        ...
        std::vector<double> salomon_eval_30_dim = evolutionary_algorithm(0.5, 2, -100, 100, 200, n_of_dim_3, 35);
...
void run_whitney() {
    ...
    for(int i =0; i < n_of_experimetns; i++) {
        std::vector<double> whitney_eval_5_dim =evolutionary_algorithm(0.5, 3, -10.24, 10.24, 45, n_of_dim_1, 5);
        ...
        std::vector<double> whitney_eval_15_dim = evolutionary_algorithm(0.5, 3, -10.24, 10.24, 100, n_of_dim_2, 18);
        ...
        std::vector<double> whitney_eval_30_dim = evolutionary_algorithm(0.5, 3, -10.24, 10.24, 200, n_of_dim_3, 35);
