...
//std::vector<double> evolutionaryAlgorithm() {
//    auto population = initializePopulation();
//    double best_fitness = DBL_MAX;
//    int evaluations = 0;
//    std::vector<double> evaluation_values;
//
//    // ewaluacja poczatkowej populacji
//    for (const auto& individual : population) {
//        best_fitness = std::min(best_fitness, evaluation_function_1(individual)); // albo 2
//        evaluations++;
//    }
//
//    evaluation_values.push_back(best_fitness);
//
//    for (int eval = 0; eval < MAX_ITER; ++eval) {
...
//            best_fitness = std::min(best_fitness, evaluation_function_1(offspring));
...
//        std::vector<double> best_fitness = evolutionaryAlgorithm();
//
